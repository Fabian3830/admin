<div class="modal fade" tabindex="-1" role="dialog" id="buscarEstatua" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form class="mx-auto my-auto px-4" id="frmEditarArticulo" method="POST" style="width:100%">
                ...
                <div class="form-group col-12 my-2">
                    ...
                    <input type="text" class="form-control" name="peso-edit" id="peso-edit" value="">
                </div>
                <div class="form-group col-12 my-2">
                    <label for="mate-edit">Material</label>
                    <input type="text" class="form-control" name="mate-edit" id="mate-edit" value="">
                </div>
                <div class="form-group col-12 my-2">
