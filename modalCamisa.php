<div class="modal fade" tabindex="-1" role="dialog" id="buscarCamisa" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="border-radius: none;">
        <div class="modal-content">
            <h4 style="text-align: center">Edición</h4>
            <form class="mx-auto my-auto px-4" id="frmEditarCamisa" method="POST" style="width:100%">
